...
const temario: TemarioType = [
  {
    ...
    topics: [
      ...
      {
        tema: 'Rol del Profesional y cumplimiento de los requisitos de la Información Contable:',
        subtemas: [
      ...
      {
        tema: 'Unidad de Medida. Variables a considerar en el ambiente interno y externo de las organizaciones.',
      },
      {
      ...
      {
        tema: 'Los Usuarios de la Información Contable y el acceso digital a bases de datos.',
      },
      {
        tema: 'Información Contable para la Gestión en ambientes informatizados y/o robotizados.',
      },
      {
      ...
      {
        tema: 'Técnicas contables de medición para el reconocimiento y registro:',
        subtemas: [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        tema: 'La Auditoría y el Control Interno, en grupos económicos, adaptación a:',
        subtemas: [
      ...
      {
        tema: 'Técnicas de Auditoría específicas para el desarrollo de auditorías en:',
        subtemas: [
          'Contextos automatizados y robotizados.',
          'Contextos de alto impacto ambiental y social.',
        ],
      ...
      {
        tema: 'Técnicas de auditoría específicas para el examen de nuevos negocios en contextos automatizados y robotizados.',
      },
      {
        tema: 'La Auditoría y sus acciones en contextos automatizados y robotizados.',
      },
    ],
  },
  {
    ...
    topics: [
      {
        tema: 'La Contabilidad y la Auditoría en ambientes automatizados y robotizados.',
      },
      {
        tema: 'Los nuevos tipos de relaciones económicas que surgen de la automatización y robotización, su contabilización y auditoría.',
      },
      {
        tema: 'Marco Normativo de la Contabilidad y Auditoría, criterios a adoptar frente a la automatización y robotización.',
      },
      {
        tema: 'La Contabilidad Social y Ambiental dentro de la automatización y robotización de procesos comerciales y administrativos.',
      },
    ],
  }
]
